import type { FAQCategoryData } from "@/types";
  ...
  LOGISTICS: [
    {
      ...
      answer:
        "No travel reimbursements will be provided. Participants are responsible for their own transportation to and from the venue.",
    },
    {
